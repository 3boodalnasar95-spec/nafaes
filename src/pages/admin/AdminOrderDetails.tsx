    ...
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {order.status === 'confirmed' && (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-purple-500 hover:bg-purple-600 text-white py-3 rounded-lg transition-colors"
                >
                  <Check className="w-5 h-5" />
                  بدء التجهيز
                </button>
              ...
              {order.status === 'preparing' && (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-indigo-500 hover:bg-indigo-600 text-white py-3 rounded-lg transition-colors"
                >
                  <Check className="w-5 h-5" />
                  شحن الطلب
                </button>
              ...
              {order.status === 'shipped' && (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white py-3 rounded-lg transition-colors"
                >
                  <Check className="w-5 h-5" />
                  تأكيد التوصيل
                </button>
          ...
          {/* Payment Info */}
          <div className="bg-white rounded-xl border border-[#E8E0D5] p-6">
            <h3 className="font-bold text-[#1A1A1A] mb-4">معلومات الدفع</h3>
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                <span className="text-[#6B6B6B]">حالة الدفع</span>
