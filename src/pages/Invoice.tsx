...
<dyad-chat-summary>Added brand‑styled Invoice page and rebuilt the app</dyad-chat-summary><dyad-write path="src/pages/Invoice.tsx" description="Updated Invoice page to match NAFAES luxury brand design with gold colors and Arabic styling">
import { useState } from "react";
import { useParams, Link } from "react-router-dom";
import { Card } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
